/**
 * Legal configuration - Placeholder variables for legal pages.
...
/**
 * Endereço no Japão para onde o usuário envia seus pedidos (redirecionamento).
 * O destinatário (recipient) é sempre o usuário: nome + código da conta (preenchido no dashboard).
