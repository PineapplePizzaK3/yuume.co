-- Enriquecer snapshot dos itens de lote com valor declarado e parâmetros úteis.
  ...
  LOOP
    ...
    INSERT INTO public.calculator_batch_items (
      ...
      jsonb_build_object(
        ...
        'declared_value_yen', v_product.declared_value_yen,
        'customs_factor', v_product.customs_factor,
        'margin_percent', v_product.margin_percent,
        'brl_per_jpy', v_product.brl_per_jpy,
