...
const CONTENT = {
  ja: {
    ...
    sections: (c) => ({
      ...
      payment: ['受け付け可能な決済手段', 'クレジットカード（Stripe経由）、PIX、銀行振込'],
  ...
  'pt-BR': {
    ...
    sections: (c) => ({
      ...
      payment: ['Meios de pagamento aceitos', 'Cartão de crédito (via Stripe), PIX, transferência bancária'],
  ...
  en: {
    ...
    sections: (c) => ({
      ...
      payment: ['Accepted payment methods', 'Credit card (via Stripe), PIX, bank transfer'],
