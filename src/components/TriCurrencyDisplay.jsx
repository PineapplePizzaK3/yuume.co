 ...
 * Bandeiras em SVG (emoji de bandeira no Windows costuma virar letras BR/US/JP).
 */
...
export function TriCurrencyDisplay({
  ...
  return (
    ...
    >
      ...
      >
        <FlagIcon code="BR" size={flagSize + 2} title="Brasil" className="self-center" />
      ...
      <div className={`flex flex-wrap items-baseline gap-x-5 gap-y-1 ${secondaryCls}`}>
        ...
        >
          <FlagIcon code="JP" size={flagSize} title="Japão" className="self-center" />
        ...
        >
          <FlagIcon code="US" size={flagSize} title="Estados Unidos" className="self-center" />
