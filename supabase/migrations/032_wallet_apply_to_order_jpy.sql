-- Aplica saldo da carteira (JPY) como parte do pagamento de um pedido em awaiting_payment.
-- Se cobrir o total, finaliza o pedido (paid/products_paid). Caso contrário, mantém awaiting_payment.
...
BEGIN
  ...
  ELSIF v_order.quote_amount IS NOT NULL AND Number(v_order.quote_amount) > 0 THEN
